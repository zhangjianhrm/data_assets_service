<template>
  <div class="map">
    <div class="map-wrap" id="data-map-v2"></div>
  </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      testData: [
        ...
        { coords: [[105, 40], [130, 35, { in: 10, out: 9 }]] },
      ...
      testData2: [
        ...
        { coords: [[130, 35, { in: 10, out: 9 }], [105, 40]] },
  ...
  methods: {
    ...
    createMap() {
      ...
      let myChart = echarts.init(document.querySelector("#data-map-v2"));
